...
import 'package:gpos700/config_tef/Venda.dart';
import 'package:gpos700/config_tef/operacaoRetorno.dart';
...
class TefService {
  ...
  bool _habilitarImpressao = false;
  String _ipConfig = '';
  ...
  TefService({
    ...
    _quantParcelas = quantParcelas ?? 0;
    _habilitarImpressao = habilitarImpressao ?? false;
  }
