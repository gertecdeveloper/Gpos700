...
public class CodigoBarras2 extends ReactActivity implements View.OnClickListener, ZXingScannerView.ResultHandler {
...
//        mScannerView.resumeCameraPreview(this);
        ...
        params.putString("result", result.getBarcodeFormat()+ ": "+result.getText());
        getReactInstanceManager().getCurrentReactContext()
                .getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
                .emit("eventResult", params);
        //startCamera();
