...
//Para definir a op��o de implementa��o, Desabilte TTask, ir� utilizar TTimer
{$DEFINE __TTASK__}
...
{$IFDEF __TTASK__}
lblTitulo.text := 'Berlin '+getVersion+' (TTask)';
{$ELSE}
lblTitulo.text := 'Berlin '+getVersion+' (TTimer)';
...
begin
          ...
          ShowMessage('Transa��o negada' + #13#10 +
